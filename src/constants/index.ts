...
export const translations = {
  en: {
    ...
    emailRegisteredWithGithub: 'This email has been registered with GitHub.',
    emailRegisteredWithGoogle: 'This email has been registered with Google.',
    continueWithProvider: '\uD83D\uDC49 Continue with {0} login',
  ...
  zh: {
    ...
    register: '注册',
    login: '登录',
    loginReminder: '请先登录以继续操作。',
    signInGoogle: '使用 Google 登录',
    signInGitHub: '使用 GitHub 登录',
    emailRegisteredWithGithub: '这个邮箱已通过 GitHub 注册。',
    emailRegisteredWithGoogle: '这个邮箱已通过 Google 注册。',
    continueWithProvider: '\uD83D\uDC49 继续用 {0} 登录',
    forgotPassword: '忘记密码',
